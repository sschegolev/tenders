...
import {
  ...
  ButtonContainer, CancelButton, CompanyNameContainer,
  CredentialsContainer, FlexSpaceBetweenContainer,
  Input,
  Label,
  PasswordContainer, PhoneContainer, PhoneInputContainer,
  SiteAgreementContainer, SiteAgreementInput,
  SmallInputContainer,
  SubmitButton, TextArea, TrnContainer
} from '../styles';
